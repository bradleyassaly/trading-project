...
def _summarize_paper_run(paper_output_dir: Path) -> dict[str, Any]:
    ...
    if not summary_path.exists():
        return {
            ...
            "ev_model_type_requested": "bucketed_mean",
            "ev_model_type_used": "bucketed_mean",
            "ev_model_fallback_reason": "",
            "ev_gate_mode": "hard",
            "ev_gate_target_type": "market_proxy",
            "ev_gate_hybrid_alpha": 0.8,
            "ev_gate_training_source": "executed_trades",
            "ev_gate_normalization_method": "zscore",
            "ev_gate_normalize_within": "all_candidates",
            ...
            "avg_raw_ev_executed_trades": 0.0,
            "avg_normalized_ev_executed_trades": 0.0,
            "avg_ev_weighting_score": 0.0,
            ...
            "avg_regression_ev_executed_trades": 0.0,
            "avg_regression_ev_weighting_score": 0.0,
            "regression_ev_weighted_exposure": 0.0,
            "ev_distribution": {},
            "ev_calibration_summary": {},
            "ev_model_sample_count": 0,
            "ev_labeled_row_count": 0,
            "ev_excluded_unlabeled_row_count": 0,
            "ev_average_target_value": 0.0,
            "ev_positive_label_rate": 0.0,
    ...
    return {
        ...
        "ev_model_type_requested": str(summary_payload.get("ev_model_type_requested", "bucketed_mean") or "bucketed_mean"),
        "ev_model_type_used": str(summary_payload.get("ev_model_type_used", "bucketed_mean") or "bucketed_mean"),
        "ev_model_fallback_reason": str(summary_payload.get("ev_model_fallback_reason", "") or ""),
        "ev_gate_mode": str(summary_payload.get("ev_gate_mode", "hard") or "hard"),
        "ev_gate_target_type": str(summary_payload.get("ev_gate_target_type", "market_proxy") or "market_proxy"),
        "ev_gate_hybrid_alpha": float(summary_payload.get("ev_gate_hybrid_alpha", 0.8) or 0.8),
        ...
        "ev_gate_normalization_method": str(
            summary_payload.get("ev_gate_normalization_method", "zscore") or "zscore"
        ),
        "ev_gate_normalize_within": str(
            summary_payload.get("ev_gate_normalize_within", "all_candidates") or "all_candidates"
        ),
        "ev_gate_use_normalized_score_for_weighting": bool(
            summary_payload.get("ev_gate_use_normalized_score_for_weighting", True)
        ),
        ...
        "avg_raw_ev_executed_trades": float(summary_payload.get("avg_raw_ev_executed_trades") or 0.0),
        "avg_normalized_ev_executed_trades": float(
            summary_payload.get("avg_normalized_ev_executed_trades") or 0.0
        ),
        "avg_ev_weighting_score": float(summary_payload.get("avg_ev_weighting_score") or 0.0),
        ...
        "regression_prediction_available_count": int(summary_payload.get("regression_prediction_available_count") or 0),
        "regression_prediction_missing_count": int(summary_payload.get("regression_prediction_missing_count") or 0),
        "avg_regression_ev_executed_trades": float(summary_payload.get("avg_regression_ev_executed_trades") or 0.0),
        "avg_regression_ev_weighting_score": float(summary_payload.get("avg_regression_ev_weighting_score") or 0.0),
        "regression_ev_weighted_exposure": float(summary_payload.get("regression_ev_weighted_exposure") or 0.0),
        ...
        "ev_labeled_row_count": int(summary_payload.get("ev_labeled_row_count") or 0),
        "ev_excluded_unlabeled_row_count": int(summary_payload.get("ev_excluded_unlabeled_row_count") or 0),
        "ev_average_target_value": float(summary_payload.get("ev_average_target_value") or 0.0),
        "ev_positive_label_rate": float(summary_payload.get("ev_positive_label_rate") or 0.0),
...
def _write_summary_artifacts(
    *,
    ...
    summary_payload = {
        ...
        "ev_gate_target_type": paper_summary.get("ev_gate_target_type", "market_proxy"),
        "ev_gate_hybrid_alpha": paper_summary.get("ev_gate_hybrid_alpha", 0.8),
        "ev_gate_training_source": paper_summary.get("ev_gate_training_source", "executed_trades"),
        "ev_gate_normalization_method": paper_summary.get("ev_gate_normalization_method", "zscore"),
        "ev_gate_normalize_within": paper_summary.get("ev_gate_normalize_within", "all_candidates"),
        "ev_gate_use_normalized_score_for_weighting": paper_summary.get(
        ...
        "avg_raw_ev_executed_trades": paper_summary.get("avg_raw_ev_executed_trades", 0.0),
        "avg_normalized_ev_executed_trades": paper_summary.get("avg_normalized_ev_executed_trades", 0.0),
        "avg_ev_weighting_score": paper_summary.get("avg_ev_weighting_score", 0.0),
    ...
    lines = [
        ...
        f"- ev_gate_target_type: `{paper_summary.get('ev_gate_target_type', 'market_proxy')}`",
        f"- ev_gate_hybrid_alpha: `{paper_summary.get('ev_gate_hybrid_alpha', 0.8)}`",
        f"- ev_gate_training_source: `{paper_summary.get('ev_gate_training_source', 'executed_trades')}`",
        f"- ev_gate_normalization_method: `{paper_summary.get('ev_gate_normalization_method', 'zscore')}`",
        f"- ev_gate_normalize_within: `{paper_summary.get('ev_gate_normalize_within', 'all_candidates')}`",
        f"- ev_gate_use_normalized_score_for_weighting: `{paper_summary.get('ev_gate_use_normalized_score_for_weighting', True)}`",
        ...
        f"- avg_raw_ev_executed_trades: `{paper_summary.get('avg_raw_ev_executed_trades', 0.0)}`",
        f"- avg_normalized_ev_executed_trades: `{paper_summary.get('avg_normalized_ev_executed_trades', 0.0)}`",
        f"- avg_ev_weighting_score: `{paper_summary.get('avg_ev_weighting_score', 0.0)}`",
...
def _build_multi_strategy_paper_config(result, reserve_cash_pct: float, workflow_config) -> PaperTradingConfig:
    ...
    return PaperTradingConfig(
        ...
        ev_gate_target_type=str(getattr(workflow_config, "ev_gate_target_type", "market_proxy") or "market_proxy"),
        ev_gate_hybrid_alpha=float(getattr(workflow_config, "ev_gate_hybrid_alpha", 0.8) or 0.8),
        ...
        ev_gate_normalization_method=str(
            getattr(workflow_config, "ev_gate_normalization_method", "zscore") or "zscore"
        ),
        ev_gate_normalize_within=str(
            getattr(workflow_config, "ev_gate_normalize_within", "all_candidates") or "all_candidates"
        ),
        ev_gate_use_normalized_score_for_weighting=bool(
            getattr(workflow_config, "ev_gate_use_normalized_score_for_weighting", True)
        ),
